...
template <> constexpr inline auto FormUdpClient::qt_create_metaobjectdata<qt_meta_tag_ZN13FormUdpClientE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "on_pushButton_UDPClientClose_clicked",
        "ReadSeverDatagramFunc"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_pushButton_UDPClientSendMsg_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_UDPClientClose_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'ReadSeverDatagramFunc'
...
void FormUdpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pushButton_UDPClientClose_clicked(); break;
        case 2: _t->ReadSeverDatagramFunc(); break;
        default: ;
        }
    }
    (void)_a;
