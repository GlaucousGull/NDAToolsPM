...
template <> constexpr inline auto FormTcpServer::qt_create_metaobjectdata<qt_meta_tag_ZN13FormTcpServerE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_pushButton_TCPServerClose_clicked",
        "on_pushButton_TCPServerStart_clicked",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_pushButton_TCPServerStop_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_TCPServerClose_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_TCPServerStart_clicked'
...
void FormTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pushButton_TCPServerSendMsg_clicked(); break;
        case 1: _t->on_pushButton_TCPServerStop_clicked(); break;
        case 2: _t->on_pushButton_TCPServerClose_clicked(); break;
        case 3: _t->on_pushButton_TCPServerStart_clicked(); break;
        case 4: _t->TcpServerConnectedFunc(); break;
        case 5: _t->ClientDisconnectedFunc(); break;
        case 6: _t->ReadAllDataFunc(); break;
        case 7: _t->saveLog(); break;
        default: ;
        }
    }
    (void)_a;
